...
- **配置**：示例位于 `config.yaml`，覆盖 `common/landing/download`，含 pathRules、fairQueue、throttleProfiles、originBindingDefault 以及 landing.turnstile/pageSecret。实际部署需替换 token、上游地址等敏感字段。
